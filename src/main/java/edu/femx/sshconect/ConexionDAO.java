package edu.femx.sshconect;
	...
	public class ConexionDAO {
			...
			private final static String S_PATH_FILE_PRIVATE_KEY = "id_rsa.ppk"; 
			...
			public static void main(String[] args) throws Throwable {
				...
				try
				{
		  	      ...
		  	      List<PatologiasDTO> patologiaList = null;
		  	      List<SintomasDTO> lista_sintomas = null;
		  	      patologiaList = ConsultasSSH.listarPatologias(stmt, conn);
		  	      HashMap<PatologiasDTO, List<SintomasDTO>> hm = new HashMap<PatologiasDTO, List<SintomasDTO>>();
		  	      
		  	      for (PatologiasDTO patologia : patologiaList)
			  	      {
						lista_sintomas = ConsultasSSH.buscarSintomasPorPatologia(stmt, conn, patologia.getPato_id());
